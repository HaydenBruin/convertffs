...
<head>
	...
	<meta name="google-site-verification" content="VoLOy9wM0DlWk26Cvr0SA-3UhORS36ULLwCIA0_WFvk" />
	...
	<![endif]-->
	<script src="/js/convertFFS.js"></script>
	<link rel="stylesheet" href="css/style.css?v=10" type="text/css" />
	<!--[if lte IE 7]>
		<link rel="stylesheet" href="css/ie.css" type="text/css" />
	<![endif]--> 
	<script>
	function Start_Statistics() { setInterval("Update_Statistics()",5000); }
	function Start_Recent_Conversions() { setInterval("Update_Recent()",5000); }
	function Update_Statistics()
	{
		/*$.ajax({
			url: "get-total-conversions.php"
		}).done(function(data) {
			$('#total_conversions').html("<a style='color: #FFF;'>" + data + "</a> conversions since <a style='color: #FFF;'>19th November 2014</a>");
		});*/
		$('#total_conversions').html("<a style='color: #FFF;'>1.5 Million+</a> conversions since <a style='color: #FFF;'>launch</a>");
	}
	</script>
</head>
<body onload="Update_Statistics(); Start_Statistics();">
	<noscript>
	...
	<div id="addObjectFormat" class="addCustomFormat">
		...
		<br /><br />
		<input id="addObjectFormatFieldName" type="text" style="width:500px" value="Format name goes here" maxlength="200">
		<br /><br />
	...
	<!--[if lte IE 6]>
		<div id="ie6">
			Internet Explorer 6 and lower are not supported by convertFFS.<br /><br />Please upgrade to a browser that respects web standards, like any of the browsers below.<br /><br /><a href="//www.mozilla.org/firefox"><img src="images/firefox.jpg" alt="Mozilla Firefox" style="padding:5px"/></a><a href="//www.google.com/chrome"><img src="images/chrome.jpg" alt="Google Chrome" style="padding:5px"/></a><br /><a href="http://www.apple.com/safari/"><img src="images/safari.jpg" alt="Safari" style="padding:5px"/></a><a href="http://www.opera.com/"><img src="images/opera.jpg" alt="Opera" style="padding:5px"/></a>
		</div>
	<![endif]-->
	<!--
	*
	...
	*
	...
	<div id="wrapper">
		<div id="dropDownContainer">
			<div id="dropDown">
				...
				<div id="dropDownRight">
					...
					Found a bug? Have an idea? <a href="http://forum.sa-mp.com/member.php?u=98695"><br>PM Haydz on the SA-MP forums!</a><br /><br />
				</div>
				<div id="dropDownCenter">
					...
					<strong id="conversionsTotal">(Loading)</strong> conversions since November 2014<br />
		...
		<div id="pageContainer">
			...
			<div id="optionsBlock" class="spriteBg">
				...
				<div style="text-align: center; margin-top: 70px; color: #FFF;"><a id="total_conversions"></a></div>
			</div>
		...
		<div id="pageContainerConverted">
			...
			<div id="outputArea">
				<div class="resizableTextarea">
                    <form action="/create-paste.php" method="post">
                        <textarea name="paste" id="outputAreaElement" class="outputAreaElementWait" readonly="readonly" wrap="off"></textarea>
    ...
    <!--<div style="width: 981px; display: block; margin: 0px auto; position: relative;">
        <a href="samp://167.114.145.46:8888" target="_blank"><img src="/convertffs-server.png" style="width: 100%; position: relative; top: 8px; z-index: -1; height: 50px;"></a>
        <div style="position: absolute; right: 0px; bottom: -22px; color: #ccc;"><a href="http://shoppeaesthetics.com/shop/?utm=convertffs" target="_blank"><img style="position: relative; top: 2px;" width="16px" height="16px" src="/images/Cart-16.png"> Check out Shop Aesthetics</a> Server IP: <a href="samp://167.114.145.46:8888" target="_blank">167.114.145.46:8888</a> - Website URL: <a href="http://www.gta-cnr.com/" target="_blank">www.gta-cnr.com</a></div>
    </div>!-->

	<?php if(@$_REQUEST['sale123131']) { ?>
		<a href="mailto:bruinhayden@gmail.com">
			<div style="background: #FF0000; color: #FFF; position: absolute; bottom: 0px; left: 0px; width: 100%;">
				<div style="padding: 12px 30px; text-align: center;">I no longer have time to manage ConvertFFS, so I'm looking for a new owner - email <span style="text-decoration: underline;">bruinhayden@gmail.com</span> with offers or for more information.</div>
			</div>
		</a>
	<?php } ?>
</body>
